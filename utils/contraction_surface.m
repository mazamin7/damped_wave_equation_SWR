function [Z_p2, Z_inf] = contraction_surface(N, a, M, T, c, dh, dt, gamma, nu, J, THETA1, THETA2)
    ...
    for i = 1:size(THETA1, 1)
        for j = 1:size(THETA1, 2)
            ...
            Z_p2(i, j) = obj_L2(N, T, dt, J, c, gamma, nu, a, M, THETA1(i, j), THETA2(i, j));
            Z_inf(i, j) = obj_Linf(N, T, dt, J, c, gamma, nu, a, M, THETA1(i, j), THETA2(i, j));
        end
    end
end