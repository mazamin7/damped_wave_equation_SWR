function [ud, final_res, res_history] = run_swr_dirichlet_1D(u0, v0, N, a_val, M, T, c, dh, dt, gamma, nu, k, u_init, u_ref)
    ...
    % Create modified matrices for each subdomain with Dirichlet conditions
    Aj_robin = cell(N, 1);
    for j = 1:N
        Aj_robin{j} = Aj;
